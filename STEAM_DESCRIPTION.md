...
[*] [b]駕駛 HUD[/b]：顯示自駕狀態、車速、巡航上限、檔位、減速原因與電油量，可直接啟停與切檔；四種主題（金屬擬物／簡約玻璃／家族卡片／側掛雙翼——側翼貼在儀表板兩側、不遮路面，可各自收放），另有精簡與收合模式，樣式、隱藏、語音與音量都在 HUD 上一鍵切換
[*] [b]速度檔位與瘋狂模式[/b]：可切換 30／50／70 km/h 與「瘋狂（車輛極速）」四檔。首發版的瘋狂檔先沿用穩定的跟線、過彎與障礙安全機制，目前主要差異是巡航上限；後續版本會重新調整為更激進、更瘋狂的駕駛行為
[*] [b]隨時接手[/b]：玩家操作方向、油門或煞車時立即交還控制；放手後保持無輸入才恢復自駕
...
[*] [b]語音提示[/b]：啟動、關閉、前方受阻、倒車脫困、交還操控、抵達、改道成功／失敗各念一句，只有自己聽得到；跟隨遊戲語言（中／英／日）或指定語音包，HUD 可開關與調音量
[*] [b]風險減速[/b]：依彎道、車頭偏差、前方殭屍／屍體、移動車輛與未載入區域調整速度；HUD tooltip 會說明目前減速政策
