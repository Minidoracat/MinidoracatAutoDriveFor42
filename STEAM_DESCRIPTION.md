...
[*] 站在車旁[b]對車輛按右鍵[/b] →「安裝自動駕駛模組」（需要螺絲起子、車用電瓶與電工 1 級）。GPS 可裝可不裝，放在背包裝上電池也能用
[*] 打開世界地圖點選目的地，規劃路線
...
[*] [b]自動駕駛模組[/b]：安裝到車輛後沿導航路線自動行駛，抵達目的地自動停車
[*] [b]駕駛 HUD[/b]：顯示自駕狀態、車速、巡航上限、檔位、減速原因與電油量，可直接啟停與切檔；四種主題（金屬擬物／簡約玻璃／家族卡片／側掛雙翼——側翼貼在儀表板兩側、不遮路面，可各自收放），另有精簡與收合模式，主題、隱藏、語音與音量都在 HUD 上一鍵切換
...
[*] [b]隨時接手[/b]：玩家操作方向、油門或煞車時立即交還控制、自動駕駛關閉（導航目標保留，再按面板即可繼續）；想要放手後自動恢復，可在選項「手動介入後」選 2／3／5／10 秒，待命期間 HUD 會倒數、接手前有提示
[*] [b]調頭方式[/b]：導航目標改到車後方時，預設「溫和」先減速到接近停車再慢慢原地迴轉；想要帶速甩尾調頭可在選項改「快速」
...
[*] [b]語音提示[/b]：啟動、關閉、前方受阻、倒車脫困、交還操控、抵達、改道成功／失敗、手動接手／恢復各念一句，只有自己聽得到；跟隨遊戲語言（中／英／日）或指定語音包，HUD 可開關與調音量
[*] [b]單人自動暫停[/b]：「脫困失敗後暫停」與「抵達後暫停」各自預設開啟，可在 ESC MOD Options／MiniMap 個別關閉。抵達先停妥；兩種情況都先關閉自駕、播完通知語音再暫停，語音關閉或不可用時直接暫停。等待中手動接手或重開自駕會取消本次暫停。只限一位本機玩家；暫時堵路、手動停止、多人／Host、分割畫面不觸發。解除暫停不重啟自駕，等待語音時世界仍會運作
...
[h2]🔗 MOD 系列[/h2]
[list]
[*] [url=https://steamcommunity.com/sharedfiles/filedetails/?id=3763913359]Minidoracat MiniMap for B42[/url](主 MOD，必裝)
