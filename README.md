...
- **單人自動暫停（兩項皆預設開啟）**：「脫困失敗後暫停」與「抵達後暫停」可在 ESC MOD Options 或 MiniMap「自動駕駛」設定各自關閉。抵達先停妥；兩種情況都先關閉自駕、播完對應語音再暫停，語音關閉或不可用時直接暫停。等待期間手動駕駛或重開自駕會取消待辦；暫時堵路仍繼續脫困，手動關閉不觸發。僅限一位本機玩家的單人遊戲，多人／Host 與分割畫面無效。解除暫停不會重啟自駕；等待語音時世界仍運作，並非掛機保命模式
