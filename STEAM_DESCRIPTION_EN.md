...
[h2]🧰 Features[/h2]
[list]
[*] [b]Vehicle devices[/b]: GPS and Autopilot occupy real parts on supported vehicles. Removal keeps charge and item data. Old installations migrate when vehicles load; conflicts preserve old records. Back up saves before updating; fully restart the game and server
