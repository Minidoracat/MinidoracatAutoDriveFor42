...
[*] [b]Driver HUD[/b]: shows autodrive state, speed, cruise limit, gear, slowdown reason, power and fuel; start/stop or change gear directly. Four themes (metal, glass, family card, side wings - two panels beside the dashboard that never cover the road, each foldable), plus compact and collapsed modes; theme, hide, voice and volume are one click on the HUD itself
