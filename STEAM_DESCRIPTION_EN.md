...
[*] [b]Driver HUD[/b]: shows autodrive state, speed, cruise limit, gear, slowdown reason, power and fuel; start/stop or change gear directly, with minimal, compact and collapsed modes
...
[*] [b]Blocked-road recovery[/b]: tries another gap and reverses out when stuck; on a fully blocked road it waits, then hands control back with a notice after a timeout (automatic re-routing is not available yet - set a new destination or route manually)
