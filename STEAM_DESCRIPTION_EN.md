...
[*] [b]Take over anytime[/b]: steering, throttle or braking immediately returns control to the player; autodrive resumes only after the controls stay idle
...
[*] [b]Voice prompts[/b]: one line each for start, stop, blocked ahead, reversing out, handing back, arrival and reroute found / not found - audible to you only; follows the game language (Chinese / English / Japanese) or a chosen voice pack, with an on/off toggle and volume slider on the HUD
